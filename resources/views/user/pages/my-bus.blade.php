...
<div class="container mar60">
  ...
  <div class="row">
      ...
      <div class="user-profile-bg">
        ...
        <div class="user-nav">
          <ul>
            ...
            <li class="current"><a href="my-bus.html"><i class="fa fa-bus"></i> My Bus</a></li>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
      ...
      <h1 class="head"><span>My Bus</span></h1>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="width:110px;">
                ...
                <a href="bus-details.html" class="edit" title="View Details"><i class="fa fa-eye"></i></a>
            ...
            <tr>
              ...
              <td>Kanpur <i class="fa fa-long-arrow-right"></i> Delhi</td>
