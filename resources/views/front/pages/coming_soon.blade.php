    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-5">
        <div class="maintenance-text">
          <h1>Coming Soon</h1>
          <h5>Something exciting is coming your way!</h5>

          <!--Progress Bar-->
          <div class="progress">
            <div class="progress-bar wow fadeInLeft" data-wow-duration="3s" data-wow-delay="1s" role="progressbar" aria-valuenow="73" aria-valuemin="0" aria-valuemax="100" style="width: 73%; visibility: visible; animation-duration: 3s; animation-delay: 1s; animation-name: fadeInLeft;"><span class="skill-percent">73%</span>
            </div>
          </div>
